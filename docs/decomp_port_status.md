...
| Player | 2 | PARTIAL_2.5.4 | run/air/slope + 17px wall/cliff + state-machine selector (player_state_t GROUND/AIR/ROLL/CROUCH/SPINDASH/LOOKUP/DROPDASH switch dispatch) + Roll + Crouch + Spindash + LookUp + DropDash moveset (Player.c:3325 Action_Jump arm jumpAbilityState=1, 3341 Action_Spindash, 3849 crouch-init minRollVel 0x11000, 3857 up-init state=LOOKUP, 4026 State_LookUp, 4047-4058 lookPos pan to -96 over 60-tick hold cap -2/frame, 4082 State_Crouch, 4131 State_Spindash, 4455-4543 State_DropDash, 6114-6216 JumpAbility_Sonic; spindash charge +0x20000 cap 0x90000, spindashCharge cap 12, release gsp=(abilityTimer>>1 & 0x7FFF8000)+0x80000; dropdash air-ramp jumpAbilityState to 22 -> DROPDASH, land launch gsp=0x80000+(gsp>>2) cap 0xC0000 -> ROLL); camera lookPos folded into Game.c cam_y; Peelout default-OFF (medal-mod only, surfaced not dropped); super/water/shields/hurt/death deferred (2.5.5-2.5.9; ANI_CROUCH/SPINDASH/LOOK_UP/DROPDASH + Dust + charge/dropdash SFX + dropdash shield/super 0xC0000/0xD0000+ShakeScreen branches deferred to 2.5.7/2.5.9) |
| SignPost | 2 | PORTED | |
