...
#elif RETRO_REV02
        // SATURN 1.03-on-v5U COMPAT ARM (Task #210 wave-1, 2026-06-11):
        // RSDK.PrintMessage + MESSAGE_STRING are the REV01 print surface
        // (GameLink.h guards both #if !RETRO_REV02); at the default
        // RETRO_REVISION=3 this branch cannot compile. The REV02 print
        // surface is PrintText -- the Plus branch above uses it with
        // identical semantics, minus the REV01 manual newline append.
        RSDK.PrintText(PRINT_NORMAL, messageText);
#else
