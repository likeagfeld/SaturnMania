...
"$LD" -r --gc-sections \
    ...
    ${P6_SPLIT:+-u _p6_w_split_mismatch -u _p6_w_split_mismatch_max -u _p6_w_split_ticks} \
    ...
    -u _p6_w_starpost_classid -u _p6_w_starpost_aniframes \
    -u _TMZ2Setup -u _p6_ovl_starpost_reset_raw \
